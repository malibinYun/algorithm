...
public class Programmers_42898 {
    public static void main(String[] args) {
        int[][] puddles = {{2, 1}, {4, 2}, {3, 3}, {1, 5}};
        System.out.println(solution(4, 5, puddles));
    }
        ...
        for (int i = 1; i <= n; i++) {
            for (int j = 1; j <= m; j++) {
                ...
                if (i == 1) {
                    ...
                    resultArr[i][j] = (resultArr[i][j - 1] + resultArr[i - 1][j]) % 1000000007;
                }
            }
        }
