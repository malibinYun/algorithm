...
fun main() {
    val stub1 = arrayOf("sun", "bed", "car")
    val stub2 = arrayOf("abce", "abcd", "cdx")
    val clazz = Programmers_12915()

    println(clazz.solution(stub1,1).toList())
    println(clazz.solution(stub2,2).toList())
}
