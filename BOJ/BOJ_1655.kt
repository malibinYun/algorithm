...
fun main() {
    ...
    val minHeap = PriorityQueue<Int>().apply { add(Int.MAX_VALUE) }
    val maxHeap = PriorityQueue<Int>(Collections.reverseOrder()).apply { add(Int.MIN_VALUE) }
    ...
    repeat(count) {
        ...
        if (maxHeap.peek() > minHeap.peek()) {
            val minHeapTop = minHeap.poll()
            val maxHeapTop = maxHeap.poll()
